      ...
      <v-dialog v-model="dialogLogin" max-width="800px">
        <v-card>
          <v-card-text>
            ...
            <v-alert outlined color="error" icon="warning" :value="error" v-text="errorText"></v-alert>
      ...
      <v-dialog v-model="dialogRegister" max-width="800px">
        <v-card>
          <v-card-text>
            ...
            <v-alert outlined color="error" icon="warning" :value="errorRegister" v-text="error"></v-alert>
  ...
  export default {
    ...
    data() {
      return {
        ...
        menu: [
          ...
          {path: '/software', label: 'Software', icon: 'list'},
    ...
    methods: {
      ...
      loginFailed(response) {
        this.error = true
        this.errorText = 'Error Login, please review the email/password'
